...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_NO, KC_X, S(KC_9), KC_NO, KC_NO, KC_NO, S(KC_0), KC_NO, KC_NO, KC_NO,
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, TG(1), KC_NO
    ),
    [1] = LAYOUT_ortho_4x10(
	CK_0, CK_1, CK_2, CK_6, CK_9, CK_5, CK_3, CK_4, CK_8, CK_7,
	CK_DOT, CK_E, CK_MNS, CK_ENT, CK_AC, CK_SLS, CK_PLS, CK_AST, CK_C, CK_MPLUS,
	CK_SLS, KC_NO, CK_BRK_OPEN, KC_NO, KC_NO, CK_M, CK_BRK_CLOSE, CK_MIN, KC_NO, CK_SIGN,
    CK_INV, CK_SQRT, CK_LOG, CK_SIN, CK_HYP, CK_COS, CK_LN, CK_POW, KC_TRNS, CK_TAN
    )
};
