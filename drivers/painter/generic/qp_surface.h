 ...
 * @return the device handle used with all drawing routines in Quantum Painter
 */
painter_device_t qp_make_mono4bpp_surface(uint16_t panel_width, uint16_t panel_height, void *buffer);
 ...
 * @return the device handle used with all drawing routines in Quantum Painter
 */
painter_device_t qp_make_mono8bpp_surface(uint16_t panel_width, uint16_t panel_height, void *buffer);
